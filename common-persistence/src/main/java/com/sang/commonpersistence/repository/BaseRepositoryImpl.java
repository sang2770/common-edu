package com.sang.commonpersistence.repository;
...
public abstract class BaseRepositoryImpl<E> implements BaseRepositoryCustom<E> {

    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public List<E> search(BaseSearchQuery query) {
        ...
        Query queryDB = entityManager.createQuery(sql.toString(), this.getClassName());
    ...
    @Override
    public Long count(BaseSearchQuery query) {
        Map<String, Object> values = new HashMap<>();
        StringBuilder sql = new StringBuilder();
    ...
    @Override
    public StringBuilder createWhereQuery(BaseSearchQuery query, Map<String, Object> values) {
        StringBuilder sql = new StringBuilder();
